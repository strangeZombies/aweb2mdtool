...
//e import { IconArrowUpRight, IconSearch, IconX } from '@tabler/icons-preact';

//e import { useTranslation } from '@/i18n';
import { cx } from '@/utils/common';
//e import { Media } from '@/types';
//e import { formatTwitterImage } from '@/utils/api';
//e import { cx, formatVideoDuration } from '@/utils/common';
//e import { ErrorBoundary } from './error-boundary';
 ...
 */
export function Modal({ show, onClose, title, class: className }: ModalProps) {
  if (!show) {
